...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['eliminar'])) {
    ...
    try {
        ...
        header("Location: registrarMarca.php");
        exit();
    } catch (Exception $e) {
        ...
        if (mysqli_errno($conexion) == 1451) { // 1451 es el código de error para la restricción de clave foránea
            $error_message = "No se puede eliminar la marca porque hay productos asociados a ella.";
        } else {
            $error_message = "Error al eliminar la Marca: " . $e->getMessage();
        }
    }
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !isset($_POST['eliminar'])) {
    ...
    try {
        ...
        $error_message = "Error al registrar marca: " . $e->getMessage();
    }
}
...
<div class="container-xl">
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Registrar <b>Marcas</b></h2>
                    </div>
                    <div class="col-sm-6 text-right">
                        <a href="#addMarcaModal" class="btn btn-success" data-toggle="modal">
                            <i class="material-icons">&#xE147;</i> <span>Agregar Marca</span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    while($row = mysqli_fetch_assoc($resultado)) {
                        echo "<tr>
                                ...
                                <td>{$row['nombre']}</td>
                                <td>
                                    <a href='actualizarMarca.php'><i class='material-icons' style='color: black; title='Editar'>&#xE254;</i></a>
                                    <form method='post' action='registrarMarca.php' style='display:inline;'>
    ...
    <!-- Ingresar Marca -->
    <div id="addMarcaModal" class="modal fade">
