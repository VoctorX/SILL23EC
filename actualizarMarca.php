                        ...
                        while($row = mysqli_fetch_assoc($resultado)) {
                            echo "<tr>
                                    ...
                                    <td style='display: flex;  align-items: center; text-align: center;'>
                                        ...
                                        <a href='registrarMarca.php' style='margin-left: 10px;'><i class='material-icons' style='color: black;' title='Agregar'>add_circle</i></a>
                                    </td>
                                </tr>";
                        }
                        ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateModalLabel">Actualizar Marca</h5>
